...
<style>
    body {
        background: linear-gradient(to left,#87b9da, #488fb8) !important;    
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                {{-- <span class="app-brand-text demo text-body fw-bolder">Sipemba</span> --}}
                        ...
                        <p class="mb-5">Silakan masukkan Username dan Password</p>
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" name="password"
                                        class="form-control @error('username') is-invalid @enderror" id="password" required
